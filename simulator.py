...
class FourierApp:
    def __init__(self, root):
        ...
        self.n_max_entry.insert(0, "0")  # Default 0
        ...
        self.n_entry.insert(0, "0")  # Default 0
    ...
    def add_entries(self, N):
        ...
        for i in range(N):
            if i < max_current:
                ...
                a_entry.insert(0, "0")  # Default 0 for a entries
                ...
                b_entry.insert(0, "0")  # Default 0 for b entries
